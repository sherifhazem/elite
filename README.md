...
## Phase 3B – Verification Hardening
- يمنع العضو من التحقق لنفس العرض أكثر من مرة خلال فترة صلاحية رمز الاستخدام.
- التحقق دائمًا مرتبط بالشريك الصحيح بناءً على `offer.company_id`.
- تسجيل محاولات التكرار ضمن ActivityLog باستخدام نتيجة `duplicate_attempt`.
- الحفاظ على الاتساق المعاملي بحيث يتم تحديث عداد الاستخدام وتسجيل ActivityLog معًا أو يتم التراجع عن الاثنين.
