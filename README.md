...
تم ضبط نافذة تفاصيل العرض في بوابة الأعضاء لتستخدم `Offer.image_url` فقط كمصدر للصورة (صورة واحدة بدون سلايدر أو مؤشرات)، مع إخفاء قسم الصور بالكامل عند غياب الرابط دون أي مساحة فارغة. تم تحديث تاريخ انتهاء العرض ليظهر كتاريخ فقط بدون وقت، مع الحفاظ على التنسيق العربي. كما تم تقليص ارتفاع الـ Modal لضمان بقاء زر التفعيل ظاهرًا بالكامل فوق شريط التنقل السفلي. التغييرات بصرية فقط دون تعديل منطق الأعمال.
